...
In the section below, we discuss the use of the operator `::` and the importance to leave no uncertainty or interpretation of R regarding the item that you want to use. To understand why it's dangerous, it's important to know how R work to find an element with a name. It's related to the search path.
